...
app.post("/submit", (req, res) => {
  ...
  // const extractedAdjValue = (adj[randomAdj]);
  // const extractedNounValue = (adj[randomnoun]);
    // console.log(extractedAdjValue);
  // console.log(extractedNounValue);

  const extractedFinalValue = (adj[randomAdj] + " " + noun[randomnoun]);
  console.log(extractedFinalValue);

  let dynamicDateForFooter = new Date().getFullYear();
  console.log(dynamicDateForFooter);
  
  

  res.render("index.ejs", {
    extractedFinalValue : extractedFinalValue,
    dynamicDateForFooter :dynamicDateForFooter
  })
